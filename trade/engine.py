...
class MainEngine:
    ...
    def add_gateway(self, gateway_class: Type[BaseGateway]) -> BaseGateway:
        ...
        # Add gateways supported exchanges into engine
    ...
    def get_gateway(self, gateway_name: str) -> BaseGateway:
        """
        Return gateways object by name.
        """
    ...
    def get_default_setting(self, gateway_name: str) -> Optional[Dict[str, Any]]:
        """
        Get default setting dict of a specific gateways.
        """
    ...
    def connect(self, setting: dict, gateway_name: str) -> None:
        """
        Start connection of a specific gateways.
        """
        gateway = self.get_gateway(gateway_name)
        if gateway:
    ...
    def subscribe(self, req: SubscribeRequest, gateway_name: str) -> None:
        """
        Subscribe tick data update of a specific gateways.
        """
        gateway = self.get_gateway(gateway_name)
        if gateway:
    ...
    def send_order(self, req: OrderRequest, gateway_name: str) -> str:
        """
        Send new order request to a specific gateways.
        """
        gateway = self.get_gateway(gateway_name)
        if gateway:
    ...
    def cancel_order(self, req: CancelRequest, gateway_name: str) -> None:
        """
        Send cancel order request to a specific gateways.
        """
        gateway = self.get_gateway(gateway_name)
        if gateway:
    ...
    def close(self) -> None:
        """
        Make sure every gateways and app is closed properly before
        programme exit.
        """
...
class LogEngine(BaseEngine):
    ...
    def register_event(self) -> None:
        """"""
        self.event_engine.register(EventType.EVENT_LOG, self.process_log_event)
...
class OmsEngine(BaseEngine):
    ...
    def register_event(self) -> None:
        """"""
        self.event_engine.register(EventType.EVENT_TICK, self.process_tick_event)
        self.event_engine.register(EventType.EVENT_ORDER, self.process_order_event)
        self.event_engine.register(EventType.EVENT_TRADE, self.process_trade_event)
        self.event_engine.register(EventType.EVENT_POSITION, self.process_position_event)
        self.event_engine.register(EventType.EVENT_ACCOUNT, self.process_account_event)
        self.event_engine.register(EventType.EVENT_CONTRACT, self.process_contract_event)
