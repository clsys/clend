...
class BaseGateway(ABC):
    """
    Abstract gateways class for creating gateways connection
    to different trading systems.

    # How to implement a gateways:

    ---
    ## Basics
    A gateways should satisfies:
    ...
    * on_contract
    ...
    # Exchanges supported in the gateways.
    ...
    def on_tick(self, tick: TickData) -> None:
        ...
        """
        self.on_event(EventType.EventType.EVENT_TICK, tick)
        self.on_event(EventType.EVENT_TICK + tick.vt_symbol, tick)
    ...
    def on_trade(self, trade: TradeData) -> None:
        ...
        self.on_event(EventType.EVENT_TRADE + trade.vt_symbol, trade)
    ...
    def on_order(self, order: OrderData) -> None:
        ...
        self.on_event(EventType.EVENT_ORDER + order.vt_orderid, order)
    ...
    def on_position(self, position: PositionData) -> None:
        ...
        self.on_event(EventType.EVENT_POSITION + position.vt_symbol, position)
    ...
    def on_account(self, account: AccountData) -> None:
        ...
        self.on_event(EventType.EVENT_ACCOUNT + account.vt_accountid, account)
    ...
    def write_log(self, msg: str) -> None:
        """
        Write a log event from gateways.
        """
    ...
    def send_order(self, req: OrderRequest) -> str:
        ...
        * assign a unique(gateways instance scope) id to OrderData.orderid
...
class LocalOrderManager:
    ...
    def on_order(self, order: OrderData) -> None:
        """
        Keep an order buf before pushing it to gateways.
        """
