...
class SubscribeRequest:
    """
    Request sending to specific gateways for subscribing tick data update.
    """
...
class OrderRequest:
    """
    Request sending to specific gateways for creating a new order.
    """
...
class CancelRequest:
    """
    Request sending to specific gateways for canceling an existing order.
    """
...
class HistoryRequest:
    """
    Request sending to specific gateways for querying history data.
    """
